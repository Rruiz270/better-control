...
export default async function TurnaroundPage() {
  ...
  try { d = await getTurnaroundView(); } catch {
    return <div className="min-h-screen"><Header title="Financeiro · Turnaround" /><p className="p-8 text-sm text-gray-400 text-center">Sem acesso ao Modo Financeiro.</p></div>;
  }
